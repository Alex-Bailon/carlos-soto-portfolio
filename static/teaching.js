export default {
	intro: ` "I hate math." That's the most common reaction I hear from people when I tell them what I do
			for a living. This reaction lives, rent-free, in my mind. How is it that so many
  ...
  courses: [ 
  {
	...
	{
      title: `<strong>Instructor</strong>`,
      dates: `Fall 2016 - Spring 2020`,
      school: '<em>Florida State University</em>',
	  location: '<em>Tallahassee, FL</em>',
	  description: `Instructor for STA 2171: Statistics for Biology, responsible for lecturing 
				and creating all coursework including worksheets and exams.`,
    },	
	{
      title: `<strong>Teaching Assistant</strong>`,
      dates: `Fall 2015 - Spring 2016`,
      school: '<em>Florida State University</em>',
	  location: '<em>Tallahassee, FL</em>',
	  description: `Teaching Assistant for CGS 2518: Spreadsheets for Business, responsible for assisting 
				students with assignments as well as grading assignments and exams. `,
    },
	{
      title: `<strong>Instructor</strong>`,
      dates: `Fall 2013 - Spring 2015`,
      school: '<em>University of Wisconsin–Milwaukee</em>',
	  location: '<em>Milwaukee, WI</em>',
	  description: `Instructor for MATH 098, MATH 108, and MATH 105, (College alebgra courses) responsible for 
	  lecturing and creating all coursework including worksheets and exams.`,
    },
